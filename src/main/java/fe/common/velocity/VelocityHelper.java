...
public class VelocityHelper {
    ...
    public static String getContent(String templateFileName, Map<String,Object> paramMap) {
        ...
        toWriter(templateFileName, velocityContext, writer);
